...
class GeminiEvaluator:
    ...
    def summarize_clusters(self, clusters_data: List[Dict[str, Any]]) -> str:
        ...
        2. **增加更多专业板块**：
           - **### 范式演进：底层架构与算法重构** (深入探讨如 GRPO, MCP, 异构计算等底层的逻辑)
           - **### 巨头博弈：全球算力与生态位争夺战** (分析 OpenAI, Google, Meta, NVIDIA 等的深层策略)
           - **### 垂直渗透：AI 在核心产业的工程化落地** (分析医疗、金融、制造等领域的具体落地挑战与突破)
           - **### 开发者脉搏：开源社区的情绪共识与技术槽点** (深度提炼 GitHub, Twitter, Reddit 上的核心讨论)
           - **### 宏观与监管：政策红线与全球协同态势** (分析各国监管、法律诉讼对行业的影响)
        3. **深度评估与实战建议**：
           - 必须包含“【3-6个月行业影响深度评估】”，至少列出 5 个维度的预测。
           - 必须包含“【企业与开发者战术执行指南】”，提供极具可操作性的 5 条建议。
        4. **语言风格**：极其犀利、充满前瞻性、数据支撑感强，避免任何废话和客套话。
        5. **结尾**：以“【核心情报雷达：明日重点监控指标】”给出 5 条极具穿透力的监控指标。
        """
